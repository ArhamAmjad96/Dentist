...
export const practiceConfig: PracticeConfig = {
  ...
  type: "private", // Options: 'general' | 'private' | 'mixed' | 'orthodontist' | 'cosmetic' | 'dental-laboratory' | 'denture-clinic' | 'hygienist' | 'implant' | 'emergency' | 'family' | 'specialist'
  status: "private", // Options: 'private' | 'mixed' | 'nhs-focused'
  ...
  images: {
    ...
    dentistWithPatient: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1000&q=80",
